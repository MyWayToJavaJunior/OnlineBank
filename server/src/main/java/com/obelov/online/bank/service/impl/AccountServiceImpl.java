...
public class AccountServiceImpl implements AccountService {
    ...
    @Autowired
    private PrimaryAccountRepository primaryAccountRepositoy;
    ...
    public PrimaryAccount createPrimaryAccount() {
        ...
        primaryAccountRepositoy.save(primaryAccount);

        return primaryAccountRepositoy.findByAccountNumber(primaryAccount.getAccountNumber());
    }
